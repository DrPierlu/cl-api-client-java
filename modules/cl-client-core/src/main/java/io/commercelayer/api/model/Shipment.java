...
public class Shipment extends ApiResource {
  ...
  public static final List<Class<? extends ApiResource>> _RELATED_RESOURCES = Collections.unmodifiableList(Arrays.asList(ShippingMethod.class, ShippingCategory.class, StockLocation.class, Address.class, LineItem.class, Parcel.class));
